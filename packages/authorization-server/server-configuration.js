...
const configuration = {
  ...
  providers: {
    customer1: {
      ...
      authorization_endpoint: `${process.env.CUSTOMER1_AUTH_ISSUER}/auth`,
      // authorization_endpoint: `${process.env.CUSTOMER1_AUTH_ISSUER}/oauth2/v1/authorize`,
      token_endpoint: `${process.env.CUSTOMER1_AUTH_ISSUER}/token`,
      userinfo_endpoint: `${process.env.CUSTOMER1_AUTH_ISSUER}/me`,
